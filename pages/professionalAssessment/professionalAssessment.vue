	...
	<z-paging-swiper>
			...
			<view class="header">
				<view class='top page-padding'>
					<view class="top-title font-main-black-16">
						<u-navbar title="专业测评" placeholder bgColor="rgba(0,0,0,0)" :autoBack="true">
		...
		<swiper class="swiper" :current="current" @transition="swiperTransition"
			...
			<swiper-item class="swiper-item" v-for="(item, index) in tabList" :key="index">
				...
				<professional-assessment-list :tabIndex="index" :currentIndex="current"></professional-assessment-list>
			</swiper-item>
		</swiper>
	</z-paging-swiper>
</template>
