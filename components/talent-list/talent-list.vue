...
<template>
	<view class="content ">
		...
		<z-paging ref="paging" v-model="dataList" @query="queryList" :fixed="false">
			<view class='u-flex u-m-t-24 u-m-l-24 u-m-r-24'>
				<u-tag text="面部护肤" shape="circle" borderColor="#FFECE8"
					bgColor="linear-gradient(90deg, #FF7B7B 0%, #F53F3F 100%)" color="#fff">
				</u-tag>
				<u-tag class=' u-m-l-22' text="标签" shape="circle" borderColor="#F5F6F8" bgColor="#F5F6F8"
					color="#444444"> </u-tag>
			</view>

			<view class='page-padding'>
				<talent-list-item v-for='item in [1,2,3]' :key='item' class='u-m-t-40' :index='item'></talent-list-item>
			</view>

			<view class='common-wrapper page-padding'>
				<talent-list-item v-for='item in [4,5,6]' :key='item' class='u-m-b-40' :index='item'></talent-list-item>
			</view>
