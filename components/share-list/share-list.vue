...
<template>
	<view class="content page-padding u-m-t-36">
		...
		<z-paging ref="paging" v-model="dataList" @query="queryList" :fixed="false">
			...
			<!-- brand1 -->
			<see-more-brand type='golden' color='var(--tips-brown)'></see-more-brand>
			<u-grid :border="false" col="2" class='goods-container'>
				<u-grid-item class='goods-item' v-for="(item,index) in dataList.slice(0,4)" :key="index"
			...
			<!-- brand2 -->
			<see-more-brand type='red' title='榜单推荐' color='var(--main-red)'></see-more-brand>
			<u-grid :border="false" col="2" class='goods-container'>
				<u-grid-item class='goods-item' v-for="(item,index) in dataList.slice(0,4)" :key="index"
					@click="itemClick(item)">
					<!-- <view class="goods-box">
			...
			<!-- brand3 -->
			<see-more-brand type='blue' title=' 种草秀' color='var(--main-blue)'></see-more-brand>
			<u-grid :border="false" col="2" class='goods-container'>
				<u-grid-item class='goods-item' v-for="(item,index) in dataList.slice(0,4)" :key="index"
					@click="itemClick(item)">
					<!-- <view class="goods-box">
			...
			<!-- brand4 -->
			<see-more-brand type='green' title='专业评测' color='var(--main-green)'></see-more-brand>
			<u-grid :border="false" col="2" class='goods-container'>
				<u-grid-item class='goods-item' v-for="(item,index) in dataList.slice(0,4)" :key="index"
					@click="itemClick(item)">
					<!-- <view class="goods-box">
