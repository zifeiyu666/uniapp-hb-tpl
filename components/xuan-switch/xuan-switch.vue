...
<script>
	export default {
		...
		methods: {
			...
			changeAnimation() {
				if (this.isSwitch) {
					this.animationData1 = this.initAnimation.left(0).width('calc(50% - 2px)').step().export();
					this.animationData2 = this.initAnimation.width('calc(50% - 4px)').step().export();
					this.animationData3 = this.initAnimation.width('calc(50% - 4px)').step().export();
				} else {
					this.animationData1 = this.initAnimation.left('calc(50% - 2px)').width('calc(50% - 2px)').step()
						.export();
					this.animationData2 = this.initAnimation.width('calc(50% - 4px)').step().export();
					this.animationData3 = this.initAnimation.width('calc(50% - 4px)').step().export();
				}
